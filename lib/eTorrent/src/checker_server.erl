%%%-------------------------------------------------------------------
%%% File    : checker_server.erl
%%% Author  : Jesper Louis Andersen <jlouis@ogre>
%%% Description : The checker server is responsible for checking torrents
%%%
%%% Created :  8 Jul 2007 by Jesper Louis Andersen <jlouis@ogre>
%%%-------------------------------------------------------------------
-module(checker_server).
