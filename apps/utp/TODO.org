...
* TODO ZeroWindow Timeouts
** TODO Move the Zerowindow check out of handle-packet. It has no place in there
** Consider moving the window-specific code to its own module.
** TODO Install and remove the zerowindow timeout
...
*** TODO UnInstallation
   ...
   opens above 0.
** TODO Figure out the exact construction of the window probe packet
