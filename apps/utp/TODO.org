...
*** TODO 1: CONNECTED + close()
**** TODO Check the source of libutp
**** TODO We should send off a st_fin packet
...
*** TODO 1: CONNECTED -> FIN_SENT
*** TODO 2: CONNECTED -> GOT_FIN
*** TODO 3: FIN_SENT -> GOT_FIN
*** TODO 4: GOT_FIN -> RESET
*** TODO 5: RESET -> DESTROY
*** TODO 6: RESET -> GOT_FIN (why does this happen?)
*** TODO 7: GOT_FIN -> DESTROY_DELAY
*** TODO 8: FIN_SENT -> DESTROY (timeout)
*** TODO 9: DESTROY_DELAY -> DESTROY (timeout)
