...
* TODO Is handle_packet_incoming always called in the connected state?
  This looks wrong. I think that at least sometimes, we ought to have
  a call from a state different from the connected state.
* TODO Create utp_network as a module
...
** TODO Push the socket_info stuff into utp_network
...
* TODO MinRTT
  ...
  Belong: Definitely a property of the socket!
* TODO What are we *really* using the pkt_window structure for? What does it contain?
...
* TODO When considering the history, should we consider the our_history?
  Or should we rather consider one of the other history types?
* TODO How should the rto be updated and when?
