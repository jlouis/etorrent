...
** TODO ST_RESET Packet in the receive direction
   ...
   ECONNRESET!
*** TODO Detect the reset early on in the packet decoder.
    This is easier than going down to the connection itself.
*** TODO Add the ability to handle a reset() call for a given socket.
