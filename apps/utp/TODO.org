...
**** TODO GOT_FIN + recv() --> error, can't
**** TODO GOT_FIN + send() --> error, can't
...
**** TODO Should the ST_FIN packet go to the retransmit buffer?
     Yes, make it so!
...
**** TODO Has do we leave FIN_SENT?
     ...
     state.
**** TODO Figure out exactly what happens when an ST_FIN packet is received
...
**** TODO In States which are not CONNECTED, nor FIN_SENT we can't accept new data.
