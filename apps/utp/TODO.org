...
* TODO Consider what to do about the rb_drained return.
  Does it require any special handling?

  What does the libutp source do in this case?
* TODO Even though the test case says OK! there might be add things
