...
* DONE Fix this problem with bad matches:
  ...
  =SUPERVISOR REPORT==== 21-Jul-2011::18:40:53 ===
     ...
     Offender:   [{pid,<13287.74.0>},
                  ...
                  {shutdown,15000},
                  {child_type,worker}]
* TODO Why do we get packets which are "Far into the Future" on an otherwise perfect line?
  ...
  premature.
* TODO If we run two different kinds of tests, why doesn't it complete correctly?
