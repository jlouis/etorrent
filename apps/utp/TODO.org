...
* DONE Make the registry atomic upon incoming SYNs
  ...
  races.
* TODO Test the buffer draining code
  Fixed a bug around {error, eof} when closing down.
* TODO Backwards communication has some bug
...
* TODO Stress test the rwin_test for the receive window
...
** TODO Implement buffer drains in the got_fin state and so on.
...
** TODO Add an option what can cheat and force a sequence number
