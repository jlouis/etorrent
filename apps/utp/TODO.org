...
** TODO Use the RESET state to confirm a close.
...
** TODO ST_RESET Packet in the receive direction
   ...
   ECONNRESET!
** TODO ST_RESET Packet in the send direction
   ...
   table.
* TODO DESTROY how do we react on a DESTROY?
    Set a timeout
...
** TODO Write code which can walk through the senders and receivers and send them messages
